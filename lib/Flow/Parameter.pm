...
class Flow::Parameter with Util::Logger {    
    use File::Path;
    use JSON;
    use Data::Dumper;
    ...
    has 'paramname'	    => ( isa => 'Str|Undef', is => 'rw', default => undef, required => 0, documentation => q{Name of the parameter}  );
    has 'paramnumber'	    => ( isa => 'Str|Undef', is => 'rw', default => undef, required => 1, documentation => q{Number of the parameter}  );
    ...
    has 'paramtype'	    => ( isa => 'Str|Undef', is => 'rw', default => "input", documentation => q{Three possible param types: input, resource or output} );
    ...
    has 'fields'    	=> ( isa => 'ArrayRef[Str]', is => 'rw', default => sub { ['ordinal', 'paramname', 'paramnumber', 'paramtype', 'valuetype', 'category', 'argument', 'value', 'discretion', 'format', 'description', 'args', 'inputParams', 'paramFunction', 'paramfile', 'newname', 'inputfile', 'outputfile', 'outputdir', 'from', 'to', 'field', 'locked', 'chained'] } );
    has 'savefields'    => ( isa => 'ArrayRef[Str]', is => 'rw', default => sub { ['paramname', 'paramnumber', 'paramtype', 'valuetype', 'category', 'ordinal', 'argument', 'value', 'discretion', 'format', 'description', 'args', 'inputParams', 'paramFunction', 'locked', 'chained'] } );
    has 'exportfields'  => ( isa => 'ArrayRef[Str]', is => 'rw', default => sub { [ 'paramname', 'paramnumber', 'paramtype', 'valuetype', 'category', 'ordinal', 'argument', 'value', 'discretion', 'format', 'description', 'args', 'inputParams', 'paramFunction', 'locked', 'chained'] } );
    has 'tostring'  => ( isa => 'ArrayRef[Str]', is => 'rw', default => sub { [ 'ordinal', 'paramname', 'paramnumber', 'paramtype', 'value', 'valuetype', 'category',  'argument', 'discretion', 'format', 'description', 'args', 'inputParams', 'paramFunction', 'locked', 'chained'] } );
...
method getopts {
    #$self->logDebug("Flow::Parameter::getopts()");
    #$self->logDebug("Flow::Parameter::getopts    ARGV: @ARGV");
    my @temp = @ARGV;
    my $arguments = $self->arguments();
    #$self->logDebug("Flow::Parameter::getopts    arguments: ");
...
method edit {
    $self->logDebug("Flow::Parameter::edit()");
    ...
    $self->logDebug("Flow::Parameter::edit    field $field not valid") and exit if not $present;
...
method _toExportHash ($fields) {
    ...
    $self->logDebug( "tostring", $tostring );
    my $hash;
    foreach my $field ( @$fields ) {
        ...
        next if not ( grep { $_ eq $field } @$tostring );
