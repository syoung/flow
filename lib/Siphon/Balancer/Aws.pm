...
class Siphon::Master::Aws with (Logger, Siphon::Master::Common, Exchange, Agua::Common::Database, Agua::Common::Timer, Agua::Common::Project, Agua::Common::Stage, Agua::Common::Workflow, Agua::Common::Util) {
...
method setConfigMaxJobs ($queuename, $value) {
  return $self->conf()->setKey( "mq:maxjobs:$queuename:$value" ) || $self->conf()->setKey( "mq:maxjobs:default" );
}
